    ...
    <div class="col-xxl-12">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form action="<?php echo e(route('role.update',$role->id)); ?>" method="post" id="role-create-form" name="role-create-form"
                    ...
                    <div class="row">
                        <div class="row mb-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="Name" id="name" name="name" value="<?php echo e($role->name); ?>" class="form-control <?php $__errorArgs = ['name'];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/roles/edit.blade.php ENDPATH**/ ?>