                    ...
                    <div class="live-preview">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark mb-0 material-shadow" role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary border-0 material-shadow" role="alert">
                                    <strong> Hi! </strong> A simple <b>Primary alert</b> —check it out!
                                </div>

                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary border-0 material-shadow" role="alert">
                                    <strong> How are you! </strong> A simple <b>secondary alert</b> —check it out!
                                </div>

                                <h6>Success Alert</h6>
                                <div class="alert alert-success border-0 material-shadow" role="alert">
                                    <strong> Yey! Everything worked! </strong> A simple <b>success alert</b> —check it out!
                                </div>

                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger border-0 mb-xl-0 material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                <h6>Warning Alert</h6>
                                <div class="alert alert-warning border-0 material-shadow" role="alert">
                                    <strong> Uh oh, something went wrong </strong> A simple <b>warning alert</b> —check it out!
                                </div>
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light border-0 material-shadow" role="alert">
                                    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check it out!
                                </div>

                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark border-0 mb-0 material-shadow" role="alert">
                                    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible fade show material-shadow mb-xl-0" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible fade show material-shadow" role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible fade show mb-0 material-shadow" role="alert">
...
<code>&lt;!-- Dark Alert --&gt;
&lt;div class=&quot;alert alert-dark alert-dismissible fade show material-shadow&quot; role=&quot;alert&quot;&gt;
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-primary alert-dismissible border-2 bg-body-secondary fade show material-shadow" role="alert">
                                ...
                                <div class="alert alert-success alert-dismissible border-2 bg-body-secondary fade show material-shadow" role="alert">
                                    <strong> Yey! Everything worked! </strong> - Outline <b>success alert</b> example
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>

                                <h6>Danger Outline Alert</h6>
                                <div class="alert alert-danger alert-dismissible border-2 bg-body-secondary fade show mb-xl-0 material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-warning alert-dismissible border-2 bg-body-secondary fade show material-shadow" role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible border-2 bg-body-secondary fade show mb-0 material-shadow" role="alert">
...
<code>&lt;!-- Danger Alert --&gt;
&lt;div class=&quot;alert alert-danger alert-dismissible border-2 bg-body-secondary fade show material-shadow&quot; role=&quot;alert&quot;&gt;
&lt;strong&gt; Something is very wrong! &lt;/strong&gt; - Outline &lt;b&gt;danger alert&lt;/b&gt; example
&lt;button type=&quot;button&quot; class=&quot;btn-close&quot; data-bs-dismiss=&quot;alert&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
&lt;/div&gt;
</code>
...
<code>&lt;!-- Dark Alert --&gt;
&lt;div class=&quot;alert alert-dark alert-dismissible border-2 bg-body-secondary fade show material-shadow&quot; role=&quot;alert&quot;&gt;
&lt;strong&gt; Did you know? &lt;/strong&gt; - Outline &lt;b&gt;dark alert&lt;/b&gt; example
&lt;button type=&quot;button&quot; class=&quot;btn-close&quot; data-bs-dismiss=&quot;alert&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
&lt;/div&gt;
</code></pre>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-border-left alert-dismissible fade show material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-border-left alert-dismissible fade show material-shadow" role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-border-left alert-dismissible fade show mb-0 material-shadow" role="alert">
...
<code>&lt;!-- Dark Alert --&gt;
&lt;div class=&quot;alert alert-dark alert-border-left alert-dismissible fade show material-shadow&quot; role=&quot;alert&quot;&gt;
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible bg-primary text-white alert-label-icon fade show material-shadow" role="alert">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-dismissible bg-secondary text-white alert-label-icon fade show material-shadow" role="alert">
                                ...
                                <h6>Success Alert</h6>
                                <div class="alert alert-success alert-dismissible bg-success text-white alert-label-icon fade show material-shadow" role="alert">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0 material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Info Alert</h6>
                                <div class="alert alert-info alert-dismissible bg-info text-white alert-label-icon fade show material-shadow" role="alert">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible bg-light text-body alert-label-icon fade show material-shadow" role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0 material-shadow" role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible alert-additional fade show material-shadow" role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-top-border alert-dismissible fade show material-shadow" role="alert">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-top-border alert-dismissible fade show material-shadow" role="alert">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-top-border alert-dismissible fade show mb-xl-0 material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-top-border alert-dismissible fade show material-shadow" role="alert">
                                    <i class="ri-mail-line me-3 align-middle fs-16"></i><strong>Light</strong>
                                    - Top border alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-top-border alert-dismissible fade show mb-0 material-shadow" role="alert">
                                    <i class="ri-refresh-line me-3 align-middle fs-16"></i><strong>Dark</strong>
                                    - Top border alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible alert-label-icon label-arrow fade show material-shadow" role="alert">
                                    <i class="ri-mail-line label-icon"></i><strong>Light</strong>
                                    - Label icon arrow alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-label-icon label-arrow fade show mb-0 material-shadow" role="alert">
                                    <i class="ri-refresh-line label-icon"></i><strong>Dark</strong>
                                    - Label icon arrow alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-dismissible alert-label-icon rounded-label fade show material-shadow" role="alert">
                                    <i class="ri-check-double-line label-icon"></i><strong>Secondary</strong>
                                    - Rounded
                                    label alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible alert-label-icon rounded-label fade show mb-xl-0 material-shadow" role="alert">
                                    <i class="ri-error-warning-line label-icon"></i><strong>Danger</strong>
                                    - Rounded
                                    label alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Info Alert</h6>
                                <div class="alert alert-info alert-dismissible alert-label-icon rounded-label fade show material-shadow" role="alert">
                                    <i class="ri-airplay-line label-icon"></i><strong>Info</strong> -
                                    Rounded label
                                    alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible alert-label-icon rounded-label fade show material-shadow" role="alert">
                                    <i class="ri-mail-line label-icon"></i><strong>Light</strong> -
                                    Rounded label
                                    alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-label-icon rounded-label fade show mb-0 material-shadow" role="alert">
                                    <i class="ri-refresh-line label-icon"></i><strong>Dark</strong> -
                                    Rounded label
                                    alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
...
<code>&lt;!-- Dark Alert --&gt;
&lt;div class=&quot;alert alert-dark alert-dismissible alert-label-icon rounded-label fade show material-shadow&quot; role=&quot;alert&quot;&gt;
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="alert bg-primary border-primary text-white material-shadow" role="alert">
                                    <strong>Hi!</strong> - Solid <b>primary alert</b> example
                                </div>

                                <h6>Secondary Solid Alert</h6>
                                <div class="alert bg-secondary border-secondary text-white material-shadow" role="alert">
                                    <strong>How are you!</strong> - Solid <b>secondary alert</b> example
                                </div>

                                <h6>Success Solid Alert</h6>
                                <div class="alert bg-success border-success text-white material-shadow" role="alert">
                                    <strong>Yey! Everything worked! </strong> - Solid <b>success alert</b> example
                                </div>

                                <h6>Danger Solid Alert</h6>
                                <div class="alert bg-danger border-danger text-white mb-xl-0 material-shadow" role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="alert bg-warning border-warning text-white material-shadow" role="alert">
                                    <strong>Uh oh, something went wrong!</strong> - Solid <b>warning alert</b> example
                                </div>

                                <h6>Info Solid Alert</h6>
                                <div class="alert bg-info border-info text-white material-shadow" role="alert">
                                ...
                                <div class="alert bg-dark border-dark text-white mb-0 material-shadow" role="alert">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\Laravel\master\resources\views/ui-alerts.blade.php ENDPATH**/ ?>