    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="listjs-table" id="employeesList">
          <div class="row g-4 mb-3">
            <div class="col-sm-auto">
              <div>
                <a href="<?php echo e(route('employee.add')); ?>" type="button" class="btn btn-primary add-btn">Add employee</a>
              </div>
            </div>
            <div class="col-sm">
              <form method="GET" action="<?php echo e(route('employees')); ?>" id="searchForm">
                <div class="d-flex justify-content-sm-end">
                  ...
                  <a href="<?php echo e(route('employees')); ?>" type="button" class="btn bg-primary text-light">reset</a>
        ...
        <div class="justify-content-end d-flex gap-2">
          ...
          data-bs-target="#confirmationModal" data-id="<?php echo e($employee->id); ?>"><i class="bx bx-trash"></i>
          Delete</button>
          </div>
        </div>
        </td>
...
<script>
  ...
  $(document).ready(function () {
    $('.dropdown-item.employee-per-page-item').on('click', function (e) {
      ...
      var url = '<?php echo e($employees->url($employees->currentPage())); ?>' + '&perPage=' + perPage;
