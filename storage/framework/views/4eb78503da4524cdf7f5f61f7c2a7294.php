...
<?php $__env->startSection('title'); ?> Ecommerce Action <?php $__env->stopSection(); ?>
                                            ...
                                            <tbody>
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('build/images/products/img-3.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
                                                ...
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('build/images/products/img-2.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
                                                ...
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('build/images/products/img-1.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\Laravel\master\resources\views/apps-email-ecommerce.blade.php ENDPATH**/ ?>