                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-info-subtle rounded">
                                        <img src="<?php echo e(URL::asset('build/images/products/img-3.png')); ?>" alt="" style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-success-subtle rounded">
                                        <img src="<?php echo e(URL::asset('build/images/products/img-4.png')); ?>" alt="" style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                                        <a href="#!">
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-warning-subtle rounded">
                                        <img src="<?php echo e(URL::asset('build/images/products/img-5.png')); ?>" alt="" style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                                        <a href="#!">
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-secondary-subtle rounded">
                                        <img src="<?php echo e(URL::asset('build/images/products/img-6.png')); ?>" alt="" style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                                        <a href="#!">
                                ...
                                <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                            <div class="flex-shrink-0 me-2">
                                                <div class="avatar-xs">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="img-fluid rounded-circle candidate-img">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                            <div class="flex-shrink-0 me-2">
                                                <div class="avatar-xs">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="img-fluid rounded-circle candidate-img">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                    ...
                    <div class="col-lg-6">
                        <div class="card-body text-center">
                            <div class="avatar-md mb-3 mx-auto">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\Laravel\master\resources\views/widgets.blade.php ENDPATH**/ ?>