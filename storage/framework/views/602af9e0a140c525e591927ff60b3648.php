  ...
  <div class="col-xxl-12">
    ...
    <div class="card-header">
      ...
      <div class="card-body p-4">
        <form action="<?php echo e(route('expense.store')); ?>" method="post" id="expense-create-form" name="expense-create-form"
...
unset($__errorArgs, $__bag); ?>" id="date" name="date" value="<?php echo e(\Carbon\Carbon::today()->toDateString()); ?>">
...
unset($__errorArgs, $__bag); ?>" aria-placeholder="Expense Category" id="category" name="category">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-control <?php $__errorArgs = ['member'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="member" aria-placeholder="Team Member" name="member">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" placeholder="eg. 100" class="form-control <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" min="0" step="" name="amount" id="amount">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control <?php $__errorArgs = ['bill'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="bill" id="bill">
            ...
            <!-- <div class="col-md-6">
                <div class="">
                  ...
                  <div class="profile-user position-relative mb-4">
                    <img src="<?php echo e(URL::asset('build/images/new-document.png')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/expenses/create.blade.php ENDPATH**/ ?>