  ...
  <div class="col-xxl-12">
    <div class="card">
      ...
      <div class="card-body p-4">
        <form action="<?php echo e(route('product.store')); ?>" method="post" id="client-create-form" name="client-create-form"
...
unset($__errorArgs, $__bag); ?>" id="name"
                  placeholder="Product Name" value="<?php echo e(old('name')); ?>" name="name">
...
unset($__errorArgs, $__bag); ?>" id="unit_price"
                  placeholder="Unit Price" value="<?php echo e(old('unit_price')); ?>" name="unit_price">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\master\resources\views/product/create.blade.php ENDPATH**/ ?>