                    ...
                    <div class="card mt-4 card-bg-fill">
                        <div class="card-body p-4">
                            ...
                            <div class="user-thumb text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-circle img-thumbnail avatar-lg material-shadow" alt="thumbnail">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\Laravel\master\resources\views/auth-lockscreen-basic.blade.php ENDPATH**/ ?>