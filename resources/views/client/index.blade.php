  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <tr>
        <td class="client-name"><a href="{{ route('client.show',$client->id) }}">{{ $client->first_name }} {{$client->last_name}}</a></td>
        ...
        <div class="justify-content-end d-flex gap-2">
          <div class="edit">
          <a href="{{ route('client.edit',$client->id) }}" class="btn btn-sm btn-success edit-item-btn" ><i class="bx bxs-pencil"></i> Edit</a>
          </div>
          <div class="remove">
