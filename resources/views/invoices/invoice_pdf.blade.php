...
<head>
 ...
 .py-3 {
    ...
    .py-md-5 {
        /* Default to 1rem padding for all screen sizes */
        padding-top: 1rem;
        padding-bottom: 1rem;
    }
    ...
    .container {
        width: 100%;
        max-width: 1140px; /* Adjust as per your design */
        margin: 0 auto;
        padding-left: 15px;
        padding-right: 15px;
    }
                ...
                <div class="row justify-content-center px-lg-5 px-sm-1">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mb-5 pb-4 px-4">
                        ...
                        <div class="text-center">
                            <img src="{{ public_path('images/uploads/' . $settings['app-logo']) }}" class="img-fluid" alt="Logo"
