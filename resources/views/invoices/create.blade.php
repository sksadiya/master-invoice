        ...
        <div class="card-body border-bottom border-bottom-dashed p-4">
          <div class="row">
              ...
              <div>
                ...
                <div class="mb-2">
                  <textarea class="form-control bg-light border-0" id="companyAddress" rows="3"
                    placeholder="Company Address" name="companyAddress" required>{{ $settings['Address'] }}</textarea>
                  <div class="invalid-feedback">
                  </div>
                </div>
                <div>
                  <input type="text" class="form-control bg-light border-0" value="{{ $settings['zip-code'] }}"
            ...
            <div class="col-lg-4 ms-auto">
              <div class="mb-2">
                <input type="text" class="form-control bg-light border-0" value="{{ $settings['GST-NO'] }}"
              ...
              <div class="mb-2">
                <input type="email" class="form-control bg-light border-0" name="company_email"
                  value="{{ $settings['company-email'] }}" id="companyEmail" placeholder="Email Address" required />
                <div class="invalid-feedback">
                </div>
              </div>
              ...
              <div class="mb-2">
                <input type="text" class="form-control bg-light border-0" name="companyPhone"
                  value="+{{ $settings['country-code'] }} {{ $settings['company-phone']}}" data-plugin="cleave-phone"
              ...
              <div>
                <input type="text" class="form-control bg-light border-0" id="invoicenoInput" name="invoicenoInput"
                  placeholder="Invoice Number" value="{{ $settings['invoice-prefix']}}{{ $invoiceNumber }}"
                  readonly="readonly" />
                <div class="invalid-feedback">
                </div>
              </div>
          ...
          @endif
            ...
            <div class="col-lg-3 col-sm-6">
              <div>
                ...
                <input type="date" value="{{ $invoiceDate }}" name="invoice_date" class="form-control bg-light border-0"
            ...
            <div class="col-lg-3 col-sm-6">
              <div>
                ...
                <input type="date" class="form-control bg-light border-0" id="due_date" value="{{ $dueDate }}"
                  name="due_date" />
              </div>
            </div><!--end col-->
            <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="mb-3">
                              <select class="form-control" name="taxes" id="taxes" disabled>
                                @if($taxes)
                                  ...
                                  @endphp
                                  <option value="0" data-tax-value="0" {{ !$defaultTax ? 'selected' : '' }}>No Tax</option>
                                  @foreach ($taxes as $tax)
                                    <option {{ ($tax->is_default == 1) ? 'selected'  : '' }} data-tax-value="{{ $tax->value }}">{{ $tax->name }}</option>
                                  @endforeach
                                @endif
                              </select>
                            </div>
