    ...
    <div class="col-xxl-12">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form action="{{ route('role.update',$role->id) }}" method="post" id="role-create-form" name="role-create-form"
                    ...
                    <div class="row">
                        <div class="row mb-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="Name" id="name" name="name" value="{{ $role->name }}" class="form-control @error('name') is-invalid @enderror">
                                    @error('name')
