      ...
      <div class="card-body">
        <div class="listjs-table" id="departmentList">
          <div class="row g-4 mb-3">
            ...
            <div class="col-sm">
              <form method="GET" action="{{ route('departments') }}" id="searchForm">
                <div class="d-flex justify-content-sm-end">
                  ...
                  <a href="{{ route('departments') }}" type="button" class="btn bg-primary text-light">reset</a>
                </div>
              </form>
            </div>
          </div>
        ...
        <div class="justify-content-end d-flex gap-2">
          ...
          data-bs-target="#editDepartmentModel" data-id="{{ $department->id }}"
          data-name="{{ $department->name }}" data-description="{{ $department->description }}"><i class="bx bxs-pencil"></i> Edit</button>
          </div>
          <div class="remove">
          <button type="button" class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal"
          data-bs-target="#deleteRecordModal" data-id="{{ $department->id }}"><i class="bx bx-trash"></i> Delete</button>
          </div>
        </div>
        </td>
        </tr>
...
<script>
  $(document).ready(function () {
    ...
    $('.dropdown-item.department-per-page-item').on('click', function (e) {
      ...
      var url = '{{ $departments->url($departments->currentPage()) }}' + '&perPage=' + perPage;
